...
describe('application tests', () => {
  ...
  it('should render name: Vineeth Kalyan Cheppalli', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Vineeth Kalyan Cheppalli$/, undefined, true);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Vineeth Kalyan Cheppalli$/, '');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, '');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/vineethkalyancheppalli/',
    );
  });
  ...
  it('should render Resume button', () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      'https://drive.google.com/file/d/1HOAWyGDs8sjcTGJc1T1ReptePzwY5USq/view?usp=sharing',
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:vineethkalyanchepplli@gmail.com');
  });
